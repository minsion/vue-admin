    ...
    <div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Skin: Striped</h5>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Skin: Hover</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search2" type="text" class="form-input" placeholder="Search..." />
                </div>
            </div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Skin: Bordered</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search3" type="text" class="form-input" placeholder="Search..." />
                </div>
            </div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Skin: Compact</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search4" type="text" class="form-input" placeholder="Search..." />
                </div>
            </div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Skin: All</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search5" type="text" class="form-input" placeholder="Search..." />
                </div>
            </div>
