    ...
    <div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Alt Pagination</h5>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Disable First Last Pagination</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search2" type="text" class="form-input w-auto" placeholder="Search..." />
                </div>
            </div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Pagination Without Number</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search3" type="text" class="form-input w-auto" placeholder="Search..." />
                </div>
            </div>
        ...
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Next Previous</h5>
                <div class="ltr:ml-auto rtl:mr-auto">
                    <input v-model="search4" type="text" class="form-input w-auto" placeholder="Search..." />
                </div>
            </div>
